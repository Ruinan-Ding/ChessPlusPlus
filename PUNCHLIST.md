...
Overtime starts at **turn 37, ply 73** (`OVERTIME_FIRST_PLY`, derived - it was ply 67 before each numbered phase gained an initialization turn) and runs to turn 50. Both engines take the toll - the server on a move, a pass and the clock's pass, so a king on his last point cannot pass his way past it.
...
- **366 client specs**, **232 server tests**, production build clean apart from a standing
  SCSS budget warning.
